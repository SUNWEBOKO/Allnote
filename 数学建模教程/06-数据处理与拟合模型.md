...
![alt text](./image/ch06-image-1.png)
...
```
![alt text](./image/ch06-image-3.png)
...
```
![alt text](./image/ch06-image-4.png)
...
```
![alt text](./image/ch06-image-5.png)
```python
...
```
两组样本均值的散点图可视化
![alt text](./image/ch06-image-6.png)
...
![alt text](./image/ch06-image-7.png)
...
```
![alt text](./image/ch06-image-8.png)
```python
# 柱状图
from plotnine import *
(
...
```
![alt text](./image/ch06-image-9.png)
...
plt.show()
```
![alt text](./image/ch06-image-10.png)
...
plt.show()
```
![alt text](./image/ch06-image-11.png)
![alt text](./image/ch06-image-12.png)
...
```
![alt text](./image/ch06-image-13.png)
![alt text](./image/ch06-image-14.png)
...
print(p1)   # 展示p1图像
```
![alt text](./image/ch06-image-15.png)
...
plt.show()
```
![alt text](./image/ch06-image-16.png)
```python
...
print(p_single_bar)
```
![alt text](./image/ch06-image-17.png)
```python
...
plt.show()
```
![alt text](./image/ch06-image-18.png)
```python
...
print(p_mult_bar)
```
![alt text](./image/ch06-image-19.png)
```python
...
plt.show()
```
![alt text](./image/ch06-image-20.png)
```python
...
plt.show()
```
![alt text](./image/ch06-image-21.png)
```python
...
plt.show()
```
![alt text](./image/ch06-image-22.png)
...
plt.show()
```
![alt text](./image/ch06-image-23.png)
```python
...
print(p1)
```
![alt text](./image/ch06-image-24.png)
```python
...
plt.show()
```
![alt text](./image/ch06-image-25.png)
```python
# 使用Matplotlib绘制聚类散点图
...
plt.show()
```
![alt text](./image/ch06-image-26.png)
```python
# 使用plotnine绘制相关系数矩阵图：
...
print([p1, p2, p3])
```
![alt text](./image/ch06-image-27.png)
![alt text](./image/ch06-image-28.png)
![alt text](./image/ch06-image-29.png)
```python
# 使用Matplotlib/Seaborn绘制相关系数矩阵图
uniform_data = np.random.rand(10, 12)
sns.heatmap(uniform_data)
```
![alt text](./image/ch06-image-30.png)
...
plt.show()
```
![alt text](./image/ch06-image-31.png)
```python
# 使用matplotlib绘制箱线图
import seaborn as sns 
from plotnine.data import mtcars
...
plt.show()
```
![alt text](./image/ch06-image-32.png)
```python
# 使用Matplotlib绘制饼状图：
...
plt.show()
```
![alt text](./image/ch06-image-33.png)
```python
# 使用Matplotlib绘制环状图：
from matplotlib import cm, colors
df = pd.DataFrame({
...
plt.show()
```
![alt text](./image/ch06-image-34.png)
...
print(p1)
```
![alt text](./image/ch06-image-35.png)
```python
...
plt.show()
```
![alt text](./image/ch06-image-36.png)
```python
# Plotnine绘制多系列折线图
...
print(p1)
```
![alt text](./image/ch06-image-37.png)
```python
# Matplotlib 绘制多系列折线图
...
plt.show()
```
![alt text](./image/ch06-image-38.png)
## 6.5  插值模型
...
plt.show()
```
![alt text](./image/ch06-image-39.png)

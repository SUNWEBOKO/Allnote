...
![img](./image/ch10-wps2.jpg)![img](./image/ch10-wps3.jpg) 
...
![img](./image/ch10-wps17.jpg) 

图10.14 BERT的架构

![img](./image/ch10-wps18.jpg) 

图10.15 BERT的嵌入表示形式

![img](./image/ch10-wps19.jpg) 
...
其中：
 ...
 ![img](./image/ch10-wps26.jpg) 表示信号在频率为 ![img](./image/ch10-wps27.jpg) 时的频谱分量；

 ![img](./image/ch10-wps28.jpg) 表示信号在时刻 ![img](./image/ch10-wps29.jpg) 的值；

 ![img](./image/ch10-wps30.jpg) 是复指数函数，其中 ![img](./image/ch10-wps31.jpg) 是虚数单位。

这个公式表示的是将时域信号 ![img](./image/ch10-wps32.jpg) 转换为频域信号 ![img](./image/ch10-wps33.jpg) 的过程。通过积分运算，我们可以得到信号在各个频率上的分量。简单来说，傅里叶变换就是将时间上的信号转换成显示其频率成分的信号。通过这种转换，我们能够计算并分析不同频率上的信号强度。
...
| ![img](./image/ch10-wps35.png) | (10.4) |
| ----------------------- | ------ |

其中![img](./image/ch10-wps36.png)表示偏度，用于表示统计数据分布偏斜方向和程度。

- 整流平均值

| ![img](./image/ch10-wps37.png) | (10.5) |
| ----------------------- | ------ |
...
| ![img](./image/ch10-wps42.png) | (10.10) |
| ----------------------- | ------- |
...
| ![img](./image/ch10-wps43.png) | (10.11) |
| ----------------------- | ------- |
...
| ![img](./image/ch10-wps44.png) | (10.12) |
| ----------------------- | ------- |
...
| ![img](./image/ch10-wps45.png) | (10.13) |
| ----------------------- | ------- |
...
| ![img](./image/ch10-wps46.png) | (10.14) |
| ----------------------- | ------- |

其中![img](./image/ch10-wps47.png)为重心频率，![img](./image/ch10-wps48.png)和![img](./image/ch10-wps49.png)分别为时刻![img](./image/ch10-wps50.png)对应的频率值与幅值。

- 均方频率：这是一个评估功率谱重心稳定性的指标，可用于追踪功率谱中心的动态变化。其计算方法通常涉及到功率谱的二阶矩。

| ![img](./image/ch10-wps51.png) | (10.15) |
| ----------------------- | ------- |

- 频率方差：此参数反映了频率谱能量的分散程度，是评价信号频率分布稳定性的一个关键指标。频率方差越大，表明信号的能量分布越分散。 

| ![img](./image/ch10-wps52.png) | (10.16) |
| ----------------------- | ------- |
...
| ![img](./image/ch10-wps53.png) | (10.17) |
| ----------------------- | ------- |
